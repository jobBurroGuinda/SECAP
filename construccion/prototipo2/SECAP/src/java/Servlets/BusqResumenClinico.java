 ...
 * @author Job
 */
public class BusqResumenClinico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Búsqueda del resumen clínico</title>"); 
                ...
                out.println("<div id='page-wrapper'>");
                    ...
                    if(priv == 'A' || priv == 'E' || priv == 'M'){
                        ...
                        out.println("<h2>Buscar resúmenes clínicos del paciente</h2>");
                        ...
                        if(tPacientes > 0) {
                            ...
                            out.println("<table>");
                                ...
                                out.println("<tr>");
                                    ...
                                    out.println("   <td><a class='button special small' href='BuscarResumen?idPaciente=" + pacientes.get(i).getIdPaciente() + "'>Buscar resúmenes</a></td>");
                                    out.println("   <td><a class='button special small' href='NuevoResumen?idPaciente=" + pacientes.get(i).getIdPaciente() + "'>Nuevo</a></td>");
                                    out.println("   <td><a class='button special small' href='RegistrarResumenExistente?idPaciente=" + pacientes.get(i).getIdPaciente() + "'>Registrar existente</a></td>");
                                out.println("</tr>");
                                }
                            out.println("</table>");
                        } else {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BusqResumenClinico.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
