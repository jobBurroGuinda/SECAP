 ...
 * @author Job
 */
public class ResumenesClinicos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Buscar paciente</title>");
                ...
                if(priv == 'A' || priv == 'E' || priv == 'M'){
                        out.println("<br/>");
                        out.println("<br/>");
                    out.println("<h2>Buscar resumenes clínicos</h2>");
                    out.println("<form method='POST' action='BusqResumenClinico'>");
                        out.println("<div class='row uniform 50%'>");
                        out.println("   <input type='text' placeholder='Introducir nombre del paciente' id='nombrePaciente' name='nombrePaciente' required/>");
                        out.println("</div>");
